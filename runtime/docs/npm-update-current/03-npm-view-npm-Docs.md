...
Source: https://docs.npmjs.com/cli/v7/commands/npm-view/

[Skip to search](https://docs.npmjs.com/cli/v7/commands/npm-view/#search-box-input)[Skip to content](https://docs.npmjs.com/cli/v7/commands/npm-view/#skip-to-content)[npm Docs](https://docs.npmjs.com/)[npmjs.com](https://npmjs.com/)[Status](https://status.npmjs.com/)[Support](https://npmjs.com/support/)### Site navigation
...
-
  - npm CLI
    - CLI Commands
      ...
      - [npm bin](https://docs.npmjs.com/cli/v7/commands/npm-bin)
      - [npm bugs](https://docs.npmjs.com/cli/v7/commands/npm-bugs)
      ...
      - [npm deprecate](https://docs.npmjs.com/cli/v7/commands/npm-deprecate)
      ...
      - [npm doctor](https://docs.npmjs.com/cli/v7/commands/npm-doctor)
      - [npm edit](https://docs.npmjs.com/cli/v7/commands/npm-edit)
      - [npm exec](https://docs.npmjs.com/cli/v7/commands/npm-exec)
      - [npm explain](https://docs.npmjs.com/cli/v7/commands/npm-explain)
      - [npm explore](https://docs.npmjs.com/cli/v7/commands/npm-explore)
      - [npm find-dupes](https://docs.npmjs.com/cli/v7/commands/npm-find-dupes)
      - [npm fund](https://docs.npmjs.com/cli/v7/commands/npm-fund)
      - [npm help](https://docs.npmjs.com/cli/v7/commands/npm-help)
      - [npm help-search](https://docs.npmjs.com/cli/v7/commands/npm-help-search)
      - [npm hook](https://docs.npmjs.com/cli/v7/commands/npm-hook)
      - [npm init](https://docs.npmjs.com/cli/v7/commands/npm-init)
      - [npm install](https://docs.npmjs.com/cli/v7/commands/npm-install)
      - [npm install-ci-test](https://docs.npmjs.com/cli/v7/commands/npm-install-ci-test)
      - [npm install-test](https://docs.npmjs.com/cli/v7/commands/npm-install-test)
      - [npm link](https://docs.npmjs.com/cli/v7/commands/npm-link)
      - [npm logout](https://docs.npmjs.com/cli/v7/commands/npm-logout)
      - [npm ls](https://docs.npmjs.com/cli/v7/commands/npm-ls)
      - [npm org](https://docs.npmjs.com/cli/v7/commands/npm-org)
      - [npm outdated](https://docs.npmjs.com/cli/v7/commands/npm-outdated)
      - [npm owner](https://docs.npmjs.com/cli/v7/commands/npm-owner)
      - [npm pack](https://docs.npmjs.com/cli/v7/commands/npm-pack)
      - [npm ping](https://docs.npmjs.com/cli/v7/commands/npm-ping)
      - [npm pkg](https://docs.npmjs.com/cli/v7/commands/npm-pkg)
      - [npm prefix](https://docs.npmjs.com/cli/v7/commands/npm-prefix)
      - [npm profile](https://docs.npmjs.com/cli/v7/commands/npm-profile)
      ...
      - [npm repo](https://docs.npmjs.com/cli/v7/commands/npm-repo)
      - [npm restart](https://docs.npmjs.com/cli/v7/commands/npm-restart)
      - [npm root](https://docs.npmjs.com/cli/v7/commands/npm-root)
      ...
      - [npm star](https://docs.npmjs.com/cli/v7/commands/npm-star)
      - [npm stars](https://docs.npmjs.com/cli/v7/commands/npm-stars)
      - [npm start](https://docs.npmjs.com/cli/v7/commands/npm-start)
      - [npm stop](https://docs.npmjs.com/cli/v7/commands/npm-stop)
      - [npm team](https://docs.npmjs.com/cli/v7/commands/npm-team)
      - [npm test](https://docs.npmjs.com/cli/v7/commands/npm-test)
      - [npm token](https://docs.npmjs.com/cli/v7/commands/npm-token)
      - [npm uninstall](https://docs.npmjs.com/cli/v7/commands/npm-uninstall)
      - [npm unpublish](https://docs.npmjs.com/cli/v7/commands/npm-unpublish)
      - [npm unstar](https://docs.npmjs.com/cli/v7/commands/npm-unstar)
      ...
      - [npm whoami](https://docs.npmjs.com/cli/v7/commands/npm-whoami)
      - [npx](https://docs.npmjs.com/cli/v7/commands/npx)
    - Configuring npm
      - [Install](https://docs.npmjs.com/cli/v7/configuring-npm/install)
    ...
    - Using npm
      - [Registry](https://docs.npmjs.com/cli/v7/using-npm/registry)
      ...
      - [Organizations](https://docs.npmjs.com/cli/v7/using-npm/orgs)
      - [Developers](https://docs.npmjs.com/cli/v7/using-npm/developers)
      - [Removal](https://docs.npmjs.com/cli/v7/using-npm/removal)
      - [Changelog](https://docs.npmjs.com/cli/v7/using-npm/changelog)
-
- [GitHub](https://github.com/npm/documentation)

1. [CLI](https://docs.npmjs.com/cli)
2. [Commands](https://docs.npmjs.com/cli/v7/commands)
3. [npm view](https://docs.npmjs.com/cli/v7/commands/npm-view)

# npm-view

View registry infoSelect CLI Version:

Version 7.24.2 (Legacy)Table of contents- [Synopsis](https://docs.npmjs.com/cli/v7/commands/npm-view/#synopsis)
- [Description](https://docs.npmjs.com/cli/v7/commands/npm-view/#description)
- Configuration
  - [json](https://docs.npmjs.com/cli/v7/commands/npm-view/#json)
  - [workspace](https://docs.npmjs.com/cli/v7/commands/npm-view/#workspace)
  - [workspaces](https://docs.npmjs.com/cli/v7/commands/npm-view/#workspaces)
- [Output](https://docs.npmjs.com/cli/v7/commands/npm-view/#output)
- [See Also](https://docs.npmjs.com/cli/v7/commands/npm-view/#see-also)

## [Synopsis](https://docs.npmjs.com/cli/v7/commands/npm-view/#synopsis)
...
"Person" fields are shown as a string if they would be shown as an object. So, for example, this will show the list of `npm` contributors in the shortened string format. (See [`package.json`](https://docs.npmjs.com/cli/v7/configuring-npm/package-json) for more on this.)
...
## [Configuration](https://docs.npmjs.com/cli/v7/commands/npm-view/#configuration)
...
[Edit this page on GitHub](https://github.com/npm/cli/edit/release/v7/docs/content/commands/npm-view.md)6 contributors[![lukekarrys](https://github.com/lukekarrys.png?size=40)](https://github.com/lukekarrys)lukekarrys[![wraithgar](https://github.com/wraithgar.png?size=40)](https://github.com/wraithgar)wraithgar[![isaacs](https://github.com/isaacs.png?size=40)](https://github.com/isaacs)isaacs[![ruyadorno](https://github.com/ruyadorno.png?size=40)](https://github.com/ruyadorno)ruyadorno[![darcyclarke](https://github.com/darcyclarke.png?size=40)](https://github.com/darcyclarke)darcyclarke[![ethomson](https://github.com/ethomson.png?size=40)](https://github.com/ethomson)ethomsonLast edited by [lukekarrys](https://github.com/lukekarrys) on [September 30, 2021](https://github.com/npm/cli/commit/d7d5dd6aa66251805afd9009e3978f61ea732f05)## Table of contents
...
- <https://docs.npmjs.com/favicon-32x32.png?v=c2963dcad859b2b320d26051c38197fe>
- <https://docs.npmjs.com/icons/icon-48x48.png?v=c2963dcad859b2b320d26051c38197fe>
- <https://docs.npmjs.com/icons/icon-72x72.png?v=c2963dcad859b2b320d26051c38197fe>
- <https://docs.npmjs.com/icons/icon-96x96.png?v=c2963dcad859b2b320d26051c38197fe>
- <https://docs.npmjs.com/icons/icon-144x144.png?v=c2963dcad859b2b320d26051c38197fe>
- <https://docs.npmjs.com/icons/icon-192x192.png?v=c2963dcad859b2b320d26051c38197fe>
- <https://docs.npmjs.com/icons/icon-256x256.png?v=c2963dcad859b2b320d26051c38197fe>
- <https://docs.npmjs.com/icons/icon-384x384.png?v=c2963dcad859b2b320d26051c38197fe>
- <https://docs.npmjs.com/icons/icon-512x512.png?v=c2963dcad859b2b320d26051c38197fe>
- <https://github.com/lukekarrys.png?size=40>
- <https://github.com/wraithgar.png?size=40>
- <https://github.com/isaacs.png?size=40>
- <https://github.com/ruyadorno.png?size=40>
- <https://github.com/darcyclarke.png?size=40>
- <https://github.com/ethomson.png?size=40>
