...
Source: https://docs.npmjs.com/cli/v10/commands/npm-view/

[Skip to search](https://docs.npmjs.com/cli/v10/commands/npm-view/#search-box-input)[Skip to content](https://docs.npmjs.com/cli/v10/commands/npm-view/#skip-to-content)[npm Docs](https://docs.npmjs.com/)[npmjs.com](https://npmjs.com/)[Status](https://status.npmjs.com/)[Support](https://npmjs.com/support/)### Site navigation
...
-
  - npm CLI
    ...
    - Configuring npm
      ...
      - [Folders](https://docs.npmjs.com/cli/v10/configuring-npm/folders)
    ...
    - Using npm
      ...
      - [Organizations](https://docs.npmjs.com/cli/v10/using-npm/orgs)
      - [Dependency Selectors](https://docs.npmjs.com/cli/v10/using-npm/dependency-selectors)
      - [Developers](https://docs.npmjs.com/cli/v10/using-npm/developers)
      - [Removal](https://docs.npmjs.com/cli/v10/using-npm/removal)
      - [Changelog](https://docs.npmjs.com/cli/v10/using-npm/changelog)
-
- [GitHub](https://github.com/npm/documentation)

1. [CLI](https://docs.npmjs.com/cli)
2. [Commands](https://docs.npmjs.com/cli/v10/commands)
3. [npm view](https://docs.npmjs.com/cli/v10/commands/npm-view)

# npm-view

View registry infoSelect CLI Version:

Version 10.9.8 (Legacy)Table of contents- [Synopsis](https://docs.npmjs.com/cli/v10/commands/npm-view/#synopsis)
- [Description](https://docs.npmjs.com/cli/v10/commands/npm-view/#description)
- Configuration
  - [json](https://docs.npmjs.com/cli/v10/commands/npm-view/#json)
  - [workspace](https://docs.npmjs.com/cli/v10/commands/npm-view/#workspace)
  - [workspaces](https://docs.npmjs.com/cli/v10/commands/npm-view/#workspaces)
  - [include-workspace-root](https://docs.npmjs.com/cli/v10/commands/npm-view/#include-workspace-root)
- [Output](https://docs.npmjs.com/cli/v10/commands/npm-view/#output)
- [See Also](https://docs.npmjs.com/cli/v10/commands/npm-view/#see-also)

## [Synopsis](https://docs.npmjs.com/cli/v10/commands/npm-view/#synopsis)
...
## [Configuration](https://docs.npmjs.com/cli/v10/commands/npm-view/#configuration)
...
[Edit this page on GitHub](https://github.com/npm/cli/edit/release/v10/docs/lib/content/commands/npm-view.md)2 contributors[![RobinKnipe](https://github.com/RobinKnipe.png?size=40)](https://github.com/RobinKnipe)RobinKnipe[![lukekarrys](https://github.com/lukekarrys.png?size=40)](https://github.com/lukekarrys)lukekarrysLast edited by [RobinKnipe](https://github.com/RobinKnipe) on [November 14, 2023](https://github.com/npm/cli/commit/a38836ce9d703f5012ff4d4a8a4e3b9a9aedc025)## Table of contents
...
- <https://github.com/RobinKnipe.png?size=40>
